...
const Hero = () => {
    ...
    return (
        <section ref={ref} className='text-center md:px-48'>
            ...
            >
                <a download href='/Saurabh_Mahajan_Resume.pdf' className='group bg-white flex items-center gap-2 rounded-full px-7 py-3 shadow-md outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-gray-600'>
